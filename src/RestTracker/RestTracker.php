...
namespace Novanta\Sendinblue\RestTracker;
...
class RestTracker
{
    ...
    public function getCartEventData(Cart $cart)
    {
        ...
        $cart_data = [
            ...
            'tax' => $cartPresented['subtotals']['tax']['value'],
            'tax_amount' => $cartPresented['subtotals']['tax']['amount'],
            'discount' => $cartPresented['subtotals']['discounts']['value'],
            'discount_amount' => $cartPresented['subtotals']['discounts']['amount']
        ];
